    ...
    <nav class="navbar bg-light">
      ...
      <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <h2 class="text-center mt-3">Retiros</h2>
                <div class="row pt-5">
                ...
                <?php
                     ...
                     if(count($resultado)>0){
                       foreach ($resultado as $registro ) {
                         ?>
                         <p class="blockquote">$<?php echo $registro['egresos']; ?></P>
                         <a href="formRetiro.php?id=<?php echo $registro['nip']; ?>" class="btn btn-dark mt-5" style="width: 170px;">Ingresar retiro</a>
