...
<nav class="navbar bg-light">
        <div class="container-fluid">
          ...
          <a class="navbar-brand" href="saldo.php">Volver</a>
        </div>
      </nav>
...
<input type="text" class="form-control" name="saldo" id="floatingInput" placeholder="Ingresar saldo" style="width: 200px;">                      
<br>

<button type="submit" class="btn btn-dark" style="width: 100px;">Ingresar saldo</button>
</form> 
</div>  
</body>
</html> 