    ...
    <nav class="navbar bg-light">
      ...
      <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <h2 class="text-center mt-3">Depósitos</h2>
                <div class="row pt-5">
                <div class="col-sm-12 col-md-6 col-lg-12 col-xl-12 text-center">
                <?php
                     require_once '../usuario.php';
                     $publicacion=new Usuario();
                     $resultado=$publicacion->ObtenerIngreso($nipSesion);
                     if(count($resultado)>0){
                       foreach ($resultado as $registro ) {
                         ?>
                         <p class="blockquote">$<?php echo $registro['ingresos']; ?></P>
                         <a href="formDepo.php?id=<?php echo $registro['nip']; ?>" class="btn btn-dark mt-5" style="width: 170px;">Ingresar depósito</a>
